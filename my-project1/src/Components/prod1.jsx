...
function prod1() {
 ...
 <div class="">
      ...
      <div
        class="flex space-x-0 mt-10   w-full ml-5 mt-5 border border-gray-100 bg-gray-100"
      >
        <div class="flex-1 w-1/5 h-1/2 bg-white text-xl p-5 text-2xl font-bold">
          Upgrade your home | Amazon Brands & more
        ...
        <div class="flex-1 w-1/5 bg-white text-xl p-5 text-2xl font-bold mb-36">
